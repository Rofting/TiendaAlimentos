...
<div class="product-section mt-150 mb-150">
	<div class="container">
		...
		<div class="row product-lists">
			<%
				Database.connect();
				List<Usuarios> usuarios = Database.jdbi.withExtension(UsuarioDao.class, dao -> dao.getAllUsuarios());
			...
			<div class="col-lg-4 col-md-6 text-center">
				<div class="single-product-item">
					...
					<p class="product-price"><%= usuario.getNivel_actividad() %></p>
					<div class="product-buttons">
						<a href="EliminarElemento?entidad=alimento&id=<%= usuario.getId() %>" class="btn-delete">Eliminar</a>
