...
<%@ page import="com.svalero.tiendaAlimentos.util.CurrencyUtils" %>
				...
				<div class="col-lg-9 offset-lg-2 text-center">
					<div class="hero-text">
						<div class="hero-text-tablecell">
							...
							<div class="hero-btns">
								<a href="shop.jsp" class="boxed-btn">Alimentos</a>
								<a href="login.jsp" class="bordered-btn">Iniciar Sesion</a>
							</div>
						</div>
					</div>
				</div>
